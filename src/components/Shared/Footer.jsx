                ...
                <div className="flex flex-col items-center justify-center relative mb-24 md:mb-32 lg:mb-40 z-10 w-full text-center">
                   ...
                   <h2 className="font-heading font-medium tracking-tight text-[70px] sm:text-[100px] md:text-[140px] lg:text-[180px] xl:text-[220px] leading-[0.9] flex flex-col items-center">
                       ...
                       <span className="flex items-center gap-3 sm:gap-6 flex-wrap justify-center -ml-8 md:ml-0 mt-2 md:mt-0">
                           ...
                           <span className="text-transparent" style={{ WebkitTextStroke: '2px #333' }}>now</span>
                       </span>
                   </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 relative z-10 mt-12 md:mt-0">
                  ...
                  <div className="lg:col-span-5 flex flex-col items-start lg:pr-8">
                     <div className="relative rounded-[20px] overflow-hidden w-full lg:w-[450px] xl:w-[480px] aspect-4/3 z-10 shadow-xl mx-auto md:mx-0">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                           <img src="/logo-icon-white.png" alt="Logo" className="w-[80px] h-[80px] xl:w-[100px] xl:h-[100px]" />
                        </div>
                     </div>
                     ...
                     <div className="z-0 pointer-events-none text-center md:text-left mt-2 lg:mt-4 w-full">
                        <h3 className="text-transparent font-heading font-bold text-[90px] sm:text-[120px] md:text-[140px] lg:text-[160px] xl:text-[180px] leading-none uppercase opacity-10" style={{ WebkitTextStroke: '2px #888' }}>
                          Floka
                        </h3>
                     </div>
                  </div>
                  ...
                  <div className="lg:col-span-2 flex flex-col gap-6 lg:gap-8 pt-0 lg:pt-8 w-max">
                    {['About Us', 'Journal', 'Faq', 'Get In Touch', 'Careers'].map((link) => (
                       <a key={link} href="#" className="font-heading font-semibold text-[22px] xl:text-[26px] text-white hover:text-white/70 transition-colors w-fit">
                         {link}
                       </a>
                    ))}
                  </div>
                  ...
                  <div className="lg:col-span-4 flex flex-col gap-8 lg:gap-10 pt-0 lg:pt-8 lg:max-w-[400px]">
                    <p className="text-[#a0a0a0] text-[13px] xl:text-[14px] leading-[1.8] font-medium">
                      At <span className="text-white font-bold">Floka</span>, we believe furniture should be more than just functional—it should tell your story. With a focus on timeless design, sustainable materials, and expert craftsmanship, we create pieces that feel personal.
                    </p>
                    
                    <div className="flex flex-col gap-2">
                      <a href="mailto:info@floka-design.com" className="text-white font-bold text-[14px] xl:text-[15px] cursor-pointer hover:opacity-80 transition-opacity w-fit">
                        info@floka-design.com
                      </a>
                      <p className="text-white font-bold text-[14px] xl:text-[15px]">+123 (456 789 00)</p>
                      <p className="text-white font-bold text-[14px] xl:text-[15px]">12/A, Booston Tower, NYC</p>
                    </div>

                    {/* Social Media Icons */}
                    <div className="flex items-center gap-3">
                      {[FaFacebookF, FaXTwitter, FaLinkedinIn, FaBehance].map((Icon, i) => (
                        <a key={i} href="#" className="w-10 h-10 xl:w-11 xl:h-11 rounded-full border border-white/20 flex items-center justify-center group hover:bg-white hover:border-white transition-colors duration-300">
