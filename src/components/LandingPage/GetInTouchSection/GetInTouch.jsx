              ...
              <div className="flex flex-col sm:flex-row gap-10 sm:gap-16">
                ...
                <div>
                  ...
                  <div className="text-[15px] lg:text-[16px] text-white/90 leading-relaxed font-medium">
                    <p className='text-white/70'>Work and general inquiries</p>
                ...
                <div>
                  ...
                  <div className="text-[15px] lg:text-[16px] text-white/90 leading-relaxed font-medium max-w-[220px]">
                    <p className='text-white/70'>541 Melville Ave, Palo Alto, CA 94301, United States</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form className="flex flex-col gap-5">
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                ...
                <div className="flex-1 relative">
                  ...
                  <svg className="absolute right-5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#999]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <div className="flex-1 flex flex-col gap-2">
                  <label className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#777] ml-2">BUDGET</label>
                  <div className="relative">
                    ...
                    <svg className="absolute right-5 top-1/2 -translate-y-1/2 w-3 h-3 text-black pointer-events-none" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
                ...
                <div className="flex-1 flex flex-col gap-2">
                  <label className="text-[10px] font-bold tracking-[0.2em] uppercase text-[#777] ml-2">SERVICE</label>
                  <div className="relative">
                    <select className="w-full bg-[#f8f8f8] rounded-2xl px-5 py-4 text-[11px] font-bold uppercase text-black outline-none focus:ring-1 focus:ring-black/20 appearance-none cursor-pointer">
              ...
              {/* Submit Button */}
              <div className="mt-4">
                <button type="button" className="flex items-center gap-4 group cursor-pointer border-none">
