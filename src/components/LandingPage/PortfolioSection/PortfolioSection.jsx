    ...
    <section className="pt-24 md:pt-32 xl:pt-40 pb-20 md:pb-28 xl:pb-36" style={{ backgroundColor: '#f3f3f3' }}>
      <SectionContainer>
        ...
        <div className="flex justify-center mt-16 md:mt-20">
          <button className="group flex items-center gap-4 text-black font-semibold text-[11px] md:text-[12px] tracking-[0.2em] uppercase hover:opacity-70 transition-opacity duration-300">
